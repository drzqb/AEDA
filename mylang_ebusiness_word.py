...
def toid():
    ...
    train_s_writer = tf.io.TFRecordWriter('data/TFRecordFile/train_s_word.tfrecord')
    train_l_writer = tf.io.TFRecordWriter('data/TFRecordFile/train_l_word.tfrecord')
    val_writer = tf.io.TFRecordWriter('data/TFRecordFile/val_word.tfrecord')
